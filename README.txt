...
#
    ...
    Как аннулировать REFRESH токен с помощью Postman
#
    Чтобы аннулировать REFRESH токен, чтобы его больше нельзя было использовать для создания токенов JWT, выполните следующие действия:
